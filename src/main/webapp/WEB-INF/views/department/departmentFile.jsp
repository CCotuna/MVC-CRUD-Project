		...
		<div
			...
			<section class="bg-white ">
				<div class="py-2 px-4 mx-auto max-w-screen-xl text-center lg:py-8">
					<h1
						class="mb-2 text-4xl font-extrabold tracking-tight leading-none text-teal-900 md:text-5xl lg:text-6xl md:hover:text-orange-300 md:hover:shadow">SpringHR<br>
			...
			<div
				...
				<span class="w-7 h-7 text-gray-500 dark:text-gray-400 mb-3"
					aria-hidden="true">${department.departmentId} </span>
				<h5
					class="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Department Name:
					${department.departmentName}</h5>
				<p class="mb-3 font-normal text-gray-500 dark:text-gray-400">Department Description:
					${department.departmentDescription}</p>
			</div>
