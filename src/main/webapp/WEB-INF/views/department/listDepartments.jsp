	...
	<aside id="logo-sidebar"
		...
		<div
			...
			<ul
               ...
               </svg> <span class="ms-3">Components (beta)</span>
				</a></li>
				<li><a href="#"
					class="flex items-center p-2 text-teal-900 transition duration-75 rounded-lg hover:bg-teal-100 dark:hover:bg-teal-700 dark:text-white group">
						<svg
	...
	<div class="p-4 sm:ml-64">
		<div
			...
			<div class="relative overflow-x-auto shadow-md sm:rounded-lg my-8">
				...
				<!--   <h1 class="text-xl text-teal-900 my-2"><a href="<c:url value="/departments/add"/>">Create a department</a></h1>-->
				<table class="w-full text-sm text-white">
					<thead
						...
						<tr>
							...
							<th scope="col" class="px-6 py-3">Department Description</th>
					...
					<tbody>
						<c:forEach var="department" items="${departments}">
							<tr
								...
								<td class="px-6 py-4"><c:out
										value="${department.departmentDescription}" /></td>
								<td class="px-6 py-4 md:hover:text-white"><a
									href="<c:url value="/departments/${department.departmentId}"/>">Details</a>
								</td>
								<td class="px-6 py-4 md:hover:text-white"><a
									href="<c:url value="/departments/edit/${department.departmentId}"/>">Edit</a>
								</td>
								<td class="px-6 py-4 md:hover:text-white"><a
									href="<c:url value="/departments/delete/${department.departmentId}"/>">Delete</a>
								</td>
				...
				<a class="pointer" href="<c:url value="/departments/add"/>">
					<button
