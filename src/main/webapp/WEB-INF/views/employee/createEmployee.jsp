...
<body>
			...
			<section class="bg-white ">
				<div class="py-2 px-4 mx-auto max-w-screen-xl text-center lg:py-8">
					<h1
						...
						Create an employee</h1>
				</div>
			</section>

			<section class="bg-white dark:bg-teal-900">
				<div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
					<h2 class="mb-4 text-xl font-bold text-teal-900 dark:text-white">Add
						a new employee</h2>
					...
					<form:form id="form1" method="post"
						...
						<div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
							<div class="sm:col-span-2">
								<label for="firstname"
									class="block mb-2 text-sm font-medium text-teal-900 dark:text-white">firstname
								</label>
							...
							<div class="w-full">
								<label for="phoneNumber"
									class="block mb-2 text-sm font-medium text-teal-900 dark:text-white">phoneNumber</label>
							...
							<div class="w-full">
								<label for="registered"
									class="block mb-2 text-sm font-medium text-teal-900 dark:text-white">registered</label>
								<form:input type="date" path="registered" name="registered"
	...
	<form:form id="form1" method="post"
		...
		<div>
			...
			<div>
				<form:input path="lastname" name="lastname" placeholder="lastname" />
			</div>
