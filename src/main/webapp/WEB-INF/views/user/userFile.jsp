		...
		<div
			...
			<div
				...
				<span class="w-7 h-7 text-gray-500 dark:text-gray-400 mb-3"
					aria-hidden="true">${user.id } </span>
				<h5
					class="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Username:
					${user.username}</h5>
				<p class="mb-3 font-normal text-gray-500 dark:text-gray-400">Password:
					${user.password}</p>
